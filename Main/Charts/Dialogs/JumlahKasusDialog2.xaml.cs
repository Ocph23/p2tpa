...
{
    /// <summary>
    /// Interaction logic for JumlahKasusDialog2.xaml
    /// </summary>
    public partial class JumlahKasusDialog2 : ChartMaster
    {
        public JumlahKasusDialog2()
        {
            InitializeComponent();
            this.RefreshChartCommand = new CommandHandler { CanExecuteAction = x => true, ExecuteAction = RefreshActionAsync };
            this.DataContext = this;
            this.RefreshChartCommand.Execute(null);
            Title = "% Pelaku menurut Jenis Kelamin";

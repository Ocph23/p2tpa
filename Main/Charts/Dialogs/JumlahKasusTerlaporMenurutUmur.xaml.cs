...
{
    /// <summary>
    /// Interaction logic for JumlahKasusTerlaporMenurutUmur.xaml
    /// </summary>
    public partial class JumlahKasusTerlaporMenurutUmur : ChartMaster
    {
        public JumlahKasusTerlaporMenurutUmur()
        {
            InitializeComponent();
            this.RefreshChartCommand = new CommandHandler { CanExecuteAction = x => true, ExecuteAction = RefreshAction };
            this.RefreshChartCommand.Execute(null);
            Title = " % Pelaku menurut Kelompok Umur";
        ...
        private void RefreshAction(object obj)
        {
            ...
            var result = from p in source
                         ...
                         where terlapor.TanggalLahir != null
                         let age = p.TanggalLapor.Value.Year - terlapor.TanggalLahir.Year
                         group p by
                            age < 6 ? "0-5" :
                            age < 13 ? "6-12" :
                            age < 18 ? "13-17" :
